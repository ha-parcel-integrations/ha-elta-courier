"""Constants for the ELTA Courier parcel tracker integration."""
...
# repo — the full write-up lives in your own private research notes, not in
# this repo.
TRACKING_API_URL = "https://www.elta-courier.gr/track.php"
TRACKING_URL = "https://www.elta-courier.gr/track"
