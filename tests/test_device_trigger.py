"""Tests for ELTA Courier device triggers."""
from unittest.mock import AsyncMock

from homeassistant.const import CONF_DEVICE_ID, CONF_DOMAIN, CONF_PLATFORM, CONF_TYPE
from homeassistant.helpers.trigger import TriggerInfo

from custom_components.elta_courier.const import DOMAIN
from custom_components.elta_courier.device_trigger import (
    TRIGGER_EVENTS,
